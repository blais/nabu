...
\vfill
  ...
  But older becomes smarter and now I just \textbf{know} in advance that I will
  forget.  When I start a new task, I \textbf{invariably} start a new text file
  to take notes on it.
...
%-------------------------------------------------------------------------------
\begin{frame}[fragile]
  \frametitle{2005 - Travel Files - Mixed Data Example}
...
\end{verbatim}
  ...
  \item \textbf{Presentation}: that's your own thing \\
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item Its structures are recursive
  \item You have to establish conventions for recognizing the stuff you want to
    extract from your text files 
  \end{itemize}
...
\begin{frame}[fragile]
  ...
  Partial docutils pipeline (no output, just to run the extractors)
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item You can serve your extracted bookmarks from a server using RSS format
...
%-------------------------------------------------------------------------------
\begin{frame}[fragile]
  \frametitle{Debugging: Nabu Contents Browser - Extracted}
...
%-------------------------------------------------------------------------------
\begin{frame}[fragile]
  \frametitle{Debugging: Nabu Contents Browser - Upload Info}
...
\begin{frame}[fragile]
  ...
  \item you need to make sure that your set of Ids are unique
    \begin{itemize}
    \item use UUIDs (\verb=78d8a600-abb4-49c0-a0fc-1c315cddbc1a=)
    \end{itemize}

  \item You end up getting your head around the docutils document structure
  \end{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item Stabilize (I need to write more presentations for my data)
